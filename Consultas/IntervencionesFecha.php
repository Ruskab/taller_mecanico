...
<?php 
 ...
 ?>           
          ...
          <?php
      echo "<td>".substr($rec['cliente'],0,20)."</td>";
...
<?php 
           ...
           <ul class="nav1">
                  <li><a  href="">Modificar</a>
                    <ul>
                      <li><a href="../FU_MInterv.php?var1=<?php echo $rec['id'];?>&type=1">Matricula</a></li>
                      <li><a href="../FU_MInterv.php?var1=<?php echo $rec['id'];?>&type=2">Iniciada en...</a></li>
                      <li><a href="../FU_MInterv.php?var1=<?php echo $rec['id'];?>&type=3">Acabado el...</a></li>
                      <li><a href="../FU_MInterv.php?var1=<?php echo $rec['id'];?>&type=4">Comentario</a></li>
                    </ul>
                  </li>
                  </ul>
<?php 
...
?>
  ...
  <br>
  <br>
  <a id="orange" class="clas" href="IntervencionesMec.php">Volver al inicio</a>
  <br>
</div>
</body>
</html>
...
//Parametros configuracion bbdd
 ...
 if(!empty($_POST['val'])){
      ...
      if(mysqli_num_rows($list)==0){
          //FICHA NO ENCONTRADA 
          header('Location:FU_MDatos.php?var=Ficha no encontrada: '.$idF.'');
          die();
      }else{
  ...
  <div  class="floatingBox">
    <div class="contenido">
      ...
      <div class="campo"> 
       ...
       <div class="campo">
       <p>      
              <label for="codi">Fecha matriculación</label>
              <input name="d4" type="text" id="FDatos"  value="<?php echo $r['matriculacion'] ?>" />
      </p>
      </div>
      <div class="campo">
       <p>
       ...
       <div class="campo">
       <p>
              <label for="codi">Bastidor del vehiculo</label>
...
<div  class="floatingBox">
  <div class="contenido">
          ...
          <div class="campo">
            <p>
              <label for="codi">Fecha revisión del KMS</label>
              <input name="FKMS" type="date" id="FDatos" value="<?php echo $r['revision_KMS'] ?>" />
            </p>
          </div>

          <div class="campo">
            <p>
              <label for="codi">Fecha proxima ITV</label>
